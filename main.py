...
def game(player_imgs):
    ...
    hitbox_slime, hitbox_arrow = False, False,
    show_inv = False
    ...
    while FU.play:
        ...
        player.display(FU.screen, time, show_inv)
        ...
        for key in FU.key_pressed:
            if not anim_door.play and not show_inv:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if (pygame.K_F4 in FU.key_pressed and
                    ...
                    player.armored = not(player.armored)
                    ...
                    slimes.append(slime.Slime(FU.screen, time))
